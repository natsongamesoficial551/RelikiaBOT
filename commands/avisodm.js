...
export default {
  ...
  async execute(interaction, { enviarLog }) {
    ...
    const titulo    = interaction.options.getString('titulo') || 'AVISO OFICIAL — BEIRARIO';
    ...
    const embedDM = new EmbedBuilder()
      ...
      .addFields(
        {
          name: '👮 Enviado por',
          value: `${autor.displayName} — BeiraRIO`,
          inline: true
        },
        {
          name: '📅 Data',
        ...
        {
          name: '⚠️ Importante',
          value: 'Este é um aviso oficial da organização. Caso queira contestar ou tirar dúvidas, abra um ticket no servidor.',
          inline: false
        }
      )
